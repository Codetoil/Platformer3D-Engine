...
export class EventHandler {
    public static onResize(gameClient: GameEngineClientWeb) {
        gameClient.babylonEngine.resize();
    }
}

const gameClient: GameEngineClientWeb = new GameEngineClientWeb();

gameClient.ready.then((value) => {
    window.addEventListener("resize", EventHandler.onResize.bind(null, value as GameEngineClientWeb));
