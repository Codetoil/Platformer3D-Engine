...
export class GameEngineClientNative extends GameEngineClient {
    public readonly name: string = "Platformer3D Engine Native Client";
...
const gameClient: GameEngineClientNative = new GameEngineClientNative();
