...
public class Game3DView extends FrameLayout implements SurfaceHolder.Callback2,
    ...
    public Game3DView(Context context, ViewDelegate viewDelegate) {
        this(context, viewDelegate, (Activity)viewDelegate);
    }

    public Game3DView(Context context, ViewDelegate viewDelegate, Activity currentActivity) {
        super(context);

        this.primarySurfaceView = new SurfaceView(context);
        this.primarySurfaceView.setLayoutParams(Game3DView.childViewLayoutParams);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        Wrapper.surfaceChanged((int)(w / this.pixelDensityScale), (int)(h / this.pixelDensityScale),
                holder.getSurface());
    }
