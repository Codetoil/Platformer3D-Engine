...
public class Wrapper {
    ...
    public static native void activityOnRequestPermissionsResult(int requestCode,
                                                                 String[] permissions,
                                                                 int[] grantResults);

    public static native void setTouchInfo(int pointerId, float dx, float dy, boolean button,
                                           int buttonValue);
